    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=None, to='api.Tag')),
                ('tier', models.ForeignKey(blank=None, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='api.Tier')),
            ],
        ),
        migrations.CreateModel(
            name='Submission',
        ...
        migrations.AddField(
            ...
            name='status',
            field=models.ForeignKey(default=1, on_delete=django.db.models.deletion.CASCADE, to='challenges.SubmissionStatus'),
        ),
    ]
